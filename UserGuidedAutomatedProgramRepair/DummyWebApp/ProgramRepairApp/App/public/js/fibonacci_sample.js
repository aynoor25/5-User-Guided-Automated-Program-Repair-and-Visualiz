    ...
    var line_colors = JSON.stringify({"3":"60.000000","4":"60.000000","5":"0.000000","7":"120.000000","8":"120.000000","9":"120.000000","10":"120.000000","11":"120.000000","12":"120.000000","13":"120.000000","14":"120.000000","15":"120.000000","16":"120.000000","17":"60.000000"});
    var line_colors_2 = JSON.stringify({"3":"0.000000","4":"0.000000","5":"0.000000","7":"-120.000000","8":"-120.000000","9":"-120.000000","10":"-120.000000","11":"-120.000000","12":"-120.000000","13":"-120.000000","14":"-120.000000","15":"-120.000000","16":"-120.000000","17":"0.000000"});
    var line_colors_3 = JSON.stringify({"3":"120.000000","4":"120.000000","5":"-120.000000","7":"120.000000","8":"120.000000","9":"120.000000","10":"120.000000","11":"120.000000","12":"120.000000","13":"120.000000","14":"120.000000","15":"120.000000","16":"120.000000","17":"120.000000"});
    var line_colors_5= JSON.stringify({"3":"120.000000","4":"120.000000","5":"-120.000000","7":"120.000000","8":"120.000000","9":"120.000000","10":"120.000000","11":"120.000000","12":"120.000000","13":"120.000000","14":"120.000000","15":"120.000000","16":"120.000000","17":"120.000000"});
    var line_colors_reset = JSON.stringify({"3":"-120.000000","4":"-120.000000","5":"-120.000000","7":"-120.000000","8":"-120.000000","9":"-120.000000","10":"-120.000000","11":"-120.000000","12":"-120.000000","13":"-120.000000","14":"-120.000000","15":"-120.000000","16":"-120.000000","17":"-120.000000"});
    

    var show_line_colors_full_cov = true;
    var show_line_colors_2 = false;
    var show_line_colors_3 = false;
    var show_line_colors_5 = false;
    ...
    function color_lines() {
      ...
      else if (show_line_colors_5) {use_line_colors = line_colors_5;}
    ...
    function show_coverage() {
      if (tc_cov_to_show == "TC2") {
        ...
        show_line_colors_5 = false;
        tc_cov_result("TC3", "F");
      } else if (tc_cov_to_show == "TC5") {
        show_line_colors_full_cov = false;
        show_line_colors_2 = false;
        show_line_colors_3 = false;
        show_line_colors_5 = true;
        tc_cov_result("TC5", "F");
      }
      color_lines();
    }
    ...
    $( document ).ready(function() {
      checkbox_home.appendChild(makeCheckbox("+", false, "+"));
    ...
    function run() {
      ...
      "Fix: 1 \n" + 
      "TC1 => F, TC2 => P, TC3 => F, TC4 => P, TC5 => F, fix => 'mul',  \n" +  
      "Fix: 2 \n" + 
      "TC1 => P, TC2 => P, TC3 => P, TC4 => P, TC5 => P, fix => 'add', \n"; ;
      document.getElementById("error_fix_sugg").style.visibility = "visible";
      faulty_line_num = 12;    
      testcase_results_and_fixes = '{"1":{"1":"F","2":"P","3":"F","4":"P","5":"F","fix":"mul"},"2":{"1":"P","2":"P","3":"P","4":"P","5":"P","fix":"add"}}';
      document.getElementById('faulty_line_fix').innerHTML = "Faulty line number is 12, suggested fix is Replace the operator at line number 12 with add.";
      var Range = ace.require('ace/range').Range;
      ...
      editor.getSession().setAnnotations([{ row: faulty_line_num-1, text: "Replace the operator with add.", type: "error" }]);  
    ...
    function demo_go_forward() {
      ...
      if (testcase_results_and_fixes) {
        ...
        if (curr_sugg_num <= Object.keys(testcase_info).length) {
          ...
          if (update_fix) {
            document.getElementById('demo_fix').innerHTML = "Suggested fix no." + curr_sugg_num  + ": Replace the operator at line " + faulty_line_num + " with operator " + test_suite["fix"];
            update_fix = false;
    ...
    function add_testcase_element(testcase_name) {
      ...
      tc_elem.onclick = function() { 
        if (testcase_name == "TC2" || testcase_name == "TC3" || testcase_name == "TC5") {
